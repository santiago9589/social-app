...
const Sidebar = ({ }: props) => {
    ...
    return (
        <aside className={`col-span-1 row-span-6 flex flex-col  bg-green-300 rounded-xl ${data?.user?.email ? "justify-between" : "justify-start space-y-4"} h-full items-center p-4`}>
